...
<div class="container-fluid" style="height: auto">
    ...
    <div class="row">
        <article class="col-sm-9">
            <caption><h3 align="center">Thông tin tài khoản</h3></caption>
            <form method="post">
                <table border="1" cellpadding="5" align="center">
                    <tr>
                        <td>Tên</td>
                        <td><input type="text" id="name" name="name" size="45" value="<c:out value="${account.getName()}"/>"></td>
                    </tr>
                    <tr>
                        <td>Số điện thoại</td>
                        <td><input type="text" id="phoneNumber" name="phoneNumber" size="45" value="<c:out value="${account.getPhoneNumber()}"/>"></td>
                    </tr>
                    <tr>
                        <td>Địa chỉ</td>
                        <td><input type="text" id="address" name="address" size="45" value="<c:out value="${account.getAddress()}"/>"></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><input type="text" id="email" name="email" size="45" value="<c:out value="${account.getEmail()}"/>"></td>
                    </tr>
                </table>
            </form>
        </article>
